...
# 新增对 VPN 网段的支持：
ip rule del from 10.10.10.0/24 lookup ${ROUTE_TABLE} 2>/dev/null
...
# 4.2 源自 10.10.10.0/24 的流量也走同一张表
ip rule add from 10.10.10.0/24 lookup ${ROUTE_TABLE}

# 4.3 在 ROUTE_TABLE 中，所有流量默认经主路由 GW、接口 WAN_IF
